...
<head>
    ...
    <meta name="description"
        content="RootGIS is a pioneer of GIS awareness creation to the local community. Despite the fact that organizations, Academic institutions and the government have been using GIS, its understanding is not widespread in the community. " />
    ...
    <!-- Google Font -->
    <link
        href="https://fonts.googleapis.com/css0cf6.css?family=Rubik:300,300i,400,400i,500,500i,700,700i,900,900i&amp;display=swap"
        rel="stylesheet">
                ...
                <div class="col-12 px-0 px-lg-3">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-primary py-2 px-4">
                        <a class="navbar-brand " href="#">
                            <img class="svg-injector bg-light"
                                style=" padding: 10px; border-radius:5px; width: 25%; height:20%;"
                                src="{{ asset('assets/logo.svg') }}" alt="Logo"></a>
                        <!-- navbar toggler -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-lg-0">
                    ...
                    <p class="mb-0 text-white">© <a class="text-white" href="#"></a> {{ date('Y') }}. All
                        rights reserved</p>
                        <br>
                        <p>
                            @guest

                                                <a class="btn btn-warning" href="{{ route('login') }}"><i
                                                        class="ti-lock fa-flip-horizontal mr-1"></i> Login <span
                                                        class="pl-2"></span> </a>
                                        ...
                                        @else
                                                ...
                                                <a class="btn btn-warning" href="{{ route('home') }}"><i class="ti-user mr-1"></i>
                                                    {{ auth()->user()->name }}</a>
                                            </li>
                ...
                <div class="col-lg-3 col-md-6">
                    <ul class="list-unstyled mb-0">
                        <li><a class="text-white" href="#"><i class="fab fa-facebook-f pr-2"></i>Facebook</a>
                        </li>
                        <li><a class="text-white" href="#"><i class="fab fa-instagram pr-2"></i>Instagram</a>
                        </li>
                        <li><a class="text-white" href="#"><i class="fab fa-twitter pr-2"></i>Twitter</a></li>
                        <li><a class="text-white" href="#"><i class="fab fa-linkedin pr-2"></i>linkedin</a>
                        </li>
                    </ul>
                </div>
